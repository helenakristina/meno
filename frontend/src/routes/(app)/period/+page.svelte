...
<div class="mx-auto max-w-xl">
	<div class="mb-6 flex items-center justify-between">
		...
		<button
			...
			class="rounded-lg bg-rose-600 px-4 py-2 text-sm font-medium text-white hover:bg-rose-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-400 focus-visible:ring-offset-1"
		>
			Log today
		</button>
	</div>

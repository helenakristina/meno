...
<svelte:head>
	<title>Meno — Understand Your Perimenopause and Menopause Symptoms</title>
	<meta
		name="description"
		content="Meno helps you track symptoms, discover patterns, and prepare for healthcare conversations with evidence-based insights."
	/>
</svelte:head>

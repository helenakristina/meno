	...
	{#each [1, 2, 3] as _}
		<div class="animate-pulse rounded-2xl border border-neutral-200 bg-white px-6 py-5 shadow-sm" aria-hidden="true">
			...
			<div class="mb-3 flex items-start justify-between gap-3">
				<div class="space-y-2">
					<div class="h-5 w-52 rounded-md bg-neutral-200"></div>
			...
			<!-- Provider type pill -->
			<div class="mb-3 h-6 w-24 rounded-full bg-primary-50"></div>

			<!-- Insurance tags -->
			<div class="mb-4 flex items-center gap-2">
				<div class="h-4 w-16 rounded bg-neutral-100"></div>
				<div class="h-5 w-16 rounded-full bg-neutral-100"></div>
				<div class="h-5 w-20 rounded-full bg-neutral-100"></div>
				<div class="h-5 w-14 rounded-full bg-neutral-100"></div>
			</div>

			<!-- Footer: phone + button -->
			<div class="flex items-center justify-between">
				<div class="h-4 w-32 rounded bg-neutral-100"></div>
				<div class="h-8 w-44 rounded-lg bg-neutral-100"></div>
			</div>
		</div>
	{/each}
</div>

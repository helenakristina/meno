...
![Onboarding page — initial state](screenshots/06-onboarding-initial.png)
...
![Onboarding page — filled in, with a stage selected](screenshots/07-onboarding-filled.png)
...
![Onboarding page — age validation error](screenshots/08-onboarding-validation-error.png)
...
![Onboarding success screen](screenshots/09-onboarding-success.png)
